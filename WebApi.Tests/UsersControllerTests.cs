...
//             FakeController = new UsersController(mapper, fakeUserInformationRepository, fakeIdentityRepository, userManager);
//         }
//
//
//         [Trait("Category", "User")]
...
//         
//             var doctor = (OkResult) await FakeController.PutUser(7, putUserDto);
//         
...
//             };
//         
//             Assert.ThrowsAsync<Exception>(() => FakeController.PutUser(112312312, putUserDto));
//         }
//         
//         
//         [Trait("Category", "User")]
...
//             };
//         
//             var badRequestObjectResult = (OkResult) await FakeController.PutUser(1, putUserDto);
//         
...
//             };
//         
//             var badRequestObjectResult = (BadRequestObjectResult) await FakeController.PutUser(2, putUserDto);
//         
//             Assert.Equal(400, badRequestObjectResult.StatusCode);
...
//             };
//         
//             var badRequestObjectResult = (BadRequestObjectResult) await FakeController.PutUser(5, putUserDto);
//         
//             Assert.Equal(400, badRequestObjectResult.StatusCode);
...
//         
//         //    var deleteUser = await FakeController.DeleteUser(1);
//         //    var okResult = (OkResult) deleteUser;
//         
